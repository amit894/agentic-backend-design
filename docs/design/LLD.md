...
Each problem has its own subfolder. Do not write Design output here.
...
|---------|--------|--------|
| *(none yet)* | — | Fill `PROBLEM-BRIEF.md` and run `/design-round` |
...
2. Run `/design-round` or `/design-and-ship` in Cursor.
